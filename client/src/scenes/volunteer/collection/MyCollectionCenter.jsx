...
function MyCollectionCenter() {
    ...
    const columns = [
        ...
        },
        {
            ...
            width: 130,
            renderCell: (params) => (
                <Button variant="outlined" size="small" color="primary" onClick={() => acceptDelivery(params.row)}>Accept</Button>
            )
        }
    ];
    ...
    const dispatchColumns = [
        ...
        },
        {
            ...
            width: 130,
            renderCell: (params) => (
                <Button variant="outlined" size="small" color="primary" onClick={() => dispatchModal(params.row)}>Dispatch</Button>
            )
        }
    ];
